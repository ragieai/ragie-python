...
class Partitions(BaseSDK):
    ...
    def update(
        ...
        *,
        partition_id: str,
        update_partition_params: Union[
            models.UpdatePartitionParams, models.UpdatePartitionParamsTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.UpdatePartitionPartitionsPartitionIDPatchRequest(
            partition_id=partition_id,
            update_partition_params=utils.get_pydantic_model(
                update_partition_params, models.UpdatePartitionParams
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.update_partition_params,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="update_partition_partitions__partition_id__patch",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,

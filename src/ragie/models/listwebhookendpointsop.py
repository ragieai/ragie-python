...
class ListWebhookEndpointsRequestTypedDict(TypedDict):
...
class ListWebhookEndpointsRequest(BaseModel):
    cursor: Annotated[
...
class ListWebhookEndpointsResponseTypedDict(TypedDict):
    result: WebhookEndpointListTypedDict


class ListWebhookEndpointsResponse(BaseModel):
    next: Callable[[], Optional[ListWebhookEndpointsResponse]]

    result: WebhookEndpointList

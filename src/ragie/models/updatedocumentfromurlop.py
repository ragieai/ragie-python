...
class UpdateDocumentFromURLRequestTypedDict(TypedDict):
    document_id: str
    r"""The id of the document."""
    update_document_from_url_params: UpdateDocumentFromURLParamsTypedDict
...
class UpdateDocumentFromURLRequest(BaseModel):
    ...
    update_document_from_url_params: Annotated[
        UpdateDocumentFromURLParams,
